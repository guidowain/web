    ...
    <>
      ...
      <section id="contact" className={styles.contact}>
        ...
        <div className={styles.contactRight}>
          <a href={`mailto:${content.contact.email}`} className={styles.contactLink}>
